...
const Books: React.FC = () => {
  ...
  return (
    <div>
      <NavBar />
      <section className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-20 mb-5">
        {data?.books?.map((book: IBook) => (
          ...
          >
            <Link to={`/books/${book.id}`}>
              <img src={book.image} alt="Product" className="h-80 w-72 object-contain rounded-t-xl" />
